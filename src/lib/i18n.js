...
const SIDECAR_ERRORS = {
  ...
  "RSA bits must be 1024, 2048, 3072, or 4096": { zh: "RSA 位数须为 1024、2048、3072 或 4096", en: "RSA bits must be 1024, 2048, 3072, or 4096" },
...
export const chrome = {
  ...
  settings: { zh: "选择工具", en: "Choose tools" },
  done: { zh: "完成", en: "Done" },
  restore: { zh: "恢复默认", en: "Restore defaults" },
  add: { zh: "添加", en: "Add" },
  mine: { zh: "我的工具", en: "My tools" },
  emptyMine: { zh: "还没有工具。点齿轮选择要显示的工具。", en: "No tools yet. Use the gear to choose what to show." },
  run: { zh: "运行", en: "Run" },
