...
export const SUPPORTED_LOCALES = Object.freeze(["en", "es", "it", "ja", "pt-BR", "zh-CN", "zh-TW"]);
 ...
 * pick(locale, zh, en) — legacy bilingual helper (non-Chinese → en)
 */
export function pick(locale, zhOrDict, en) {
  ...
  return isZh(locale) ? zhOrDict : en;
}
